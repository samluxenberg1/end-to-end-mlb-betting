...
if __name__=='__main__':
    ...
    with mlflow.start_run() as run:
        ...
        trainer.plot_calibration_curve(X_train_init, y_train_init, save_path='src/figures/calibration_curve_train_catboost.png')
        trainer.plot_calibration_curve(X_holdout, y_holdout, save_path='src/figures/calibration_curve_holdout_catboost.png')

        # Plot feature importances
        trainer.plot_feature_importance(save_path='src/figures/feature_importances_catboost.png', top_n = 20)

        # Save model
        trainer.save_model('src/saved_models/trained_mlb_model_catboost.pkl')
