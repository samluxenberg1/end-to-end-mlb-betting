...
def plot_net_profit(df_scored: pd.DataFrame):
    plt.plot(df_scored['game_date'], df_scored['home_net_profit'], label='Home Net Profit')
    plt.plot(df_scored['game_date'], df_scored['away_net_profit'], label='Away Net Profit')
    plt.legend(loc='best')
