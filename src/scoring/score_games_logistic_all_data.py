...
from src.models.train_model_logistic import MLBModelTrainer
...
def main(scoring_date: str): 
    ...
    #         random_state=888
    #     )
    model = MLBModelTrainer.load_models("src/saved_models/trained_mlb_model_logistic_all_data.pkl")
...
if __name__=='__main__':
    ...
    feat_df.to_csv("src/scoring/output_logistic_all_data.csv", index=False)